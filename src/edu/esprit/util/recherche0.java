 ...
 * @author DarkLord_666
 */
public class recherche0 extends javax.swing.JFrame {
...
else
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(recherche0.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new recherche0().setVisible(true);
            }
        });
    }
